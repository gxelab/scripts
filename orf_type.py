...
def main(path_orf_pred, path_gtf, path_txinfo, pred_method, prefix, exclude_cds=False, unique_by_coord=False):
    """
    Determine ORF types based on known gene annotations

    \b
    path_orf_pred: path to the ORFs predicted by different methods or in bed12
    path_gtf: path to the known gene annotation in gtf format
    path_txinfo: path to transcript info

    note: txinfo file can be generated by `extract_txinfo_ensembl.R` or `gppy txinfo`
    """
    # input assertion
